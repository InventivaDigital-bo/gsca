...
@section('content')
@include('layouts.components.models', ['model'=>'420p'])
<section class="contents">
    @include('layouts.components.galery', ['model'=>'420p'])
    <div class="description">
        <div class="types">
            <a onclick="chageType('mt')" id="mt" class="ti active-type">MT</a>
            <a onclick="chageType('ctv')" id="ctv"  class="">CTV</a>
        </div>
        <div class="title">
        ...
        <div class="prices">
            <div class="price">
                ...
                <p class="data">19.600<span>$us</span></p>
            </div>
            <div class="mensual">
                <h4>CUOTA MENSUAL</h4>
                <p class="data">298<span>$us</span></p>
            </div>
        </div><div class="desc mt" id="txt">
            <p class="txt-mt"> Motor 2000cc, caja mecánica, AC, 2 airbags frontales,
                frenos ABS, pantalla táctil LCD 9", cámara de retro,
                control de audio al volante, vel. Crucero, tapizado en
                cuero ecologico.</p>
            <p class="txt-ctv"> Motor 2000cc, caja CVT 7 vel., AC, 2 airbags frontales,
                frenos ABS, radio + pantalla LCD 9" + screen mirroring
                + cámara reversa, control de audio al volante, vel.
                crucero,tapizado en cuero ecol.</p>
        </div>
...
@include('layouts.components.colors', ['model' => '420p'])
@include('layouts.components.360', ['model' => '420p'])
<div class="dt">
    <div class="title">
        <div style="width: 10rem;"></div>
        <h2>Detalles <span>Técnicos</span></h2>
        <a href="{{asset('assets/pdf/tiggo-420.pdf')}}" target="_blank"> Descarga ficha técnica</a>
    </div>
    <div id="data" class="data mt">
        ...
        <div class="list">
            <ul id="motor" class="active-data">
                ...
                <li><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Válvula 16 válvulas / DOHC DVVT</p></li>
                <li><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Desplazamiento 2.000 (cc)</p></li>
                ...
                <li><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Potencia máxima 136 / 5750 (hp / RPM)</p></li>
                <li><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Emisión Euro V</p></li>
                <li><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Torque máximo 180 / 4500 (Nm / RPM)</p></li>
            </ul>
            ...
            <ul id="tr" class="mt">
                <li class="duo mt"><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Tipo Mecánica 5 velocidades</p></li>
                <li class="duo aut"><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Tipo Automática 7 velocidades</p></li>
            ...
            <ul id="fr" class="">
                ...
                <li><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Delanteros Disco ventilado con pinza flotante</p></li>
                <li><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Traseros Disco con pinza flotante</p></li>
            </ul>
            ...
            <ul id="dcp" class="">
                ...
                <li><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Largo / ancho / alto (mm) 1298 / 1830 / 1670</p></li>
                <li><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Distancia entre ejes (mm) 2630</p></li>
                <li><img src="/assets/img/modelos/arrow_rigth.png" alt=""><p>Capacidad de combustible (L) 57</p></li>
