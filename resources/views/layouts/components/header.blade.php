...
<header>
    <a href="{{route('index')}}" class="logo" style="padding-top: 0;"><img src="/assets/logo4.png" alt=""></a>
    <div class="menu" id="menu">
        <div class="top">
            ...
            <div class="content">
                ...
                <div class="burguer" onclick="menuToggle()"><img src="/assets/img/icon/i_menu.png" alt=""></div>
            </div>
        </div>
        <div class="bot">
