...
require_once "mysql.classAuto.php";
...
class Prospecto{
    ...
    function NuevoProspectoAutoPlaza($nombre,$apellido,$correo,$telefono,$origen,$nota){
      ...
      $Mail->IsSMTP(); // Use SMTP
        ...
        $consulta="insert into prospecto (nombre, telefono, estado, codUsuario, codOrigenProspecto, fechaCreacion, email,notas)

            values ('$elnombrecompleto', '$telefono', (select codEstadoProspecto from estado_prospecto where descripcion like '%Nuevo Prospecto%'), '$codVendedorRandom','$origen', SYSDATE(), '$correo','$nota')";
