...
class Prospecto{
  ...
  function NuevoProspectoAutoPlaza($nombre,$apellido,$correo,$telefono,$origen,$nota,$marca){
      ...
      if ($nombre!="") {
            ...
            //************************************************************************ Traer Vendedor Random  *****************************************************
                                    ...
                                    $consulta="SELECT usuario.inicializado,usuario.estado2,persona.codPersona,concat(persona.nombre,' ',persona.apePat,' ',persona.apeMat) as nombre,codTipoUsuario,cargo,usuario.codUsuario as elusuario from usuario inner join persona on usuario.codPersona=persona.codPersona where usuario.codTipoUsuario=2  and usuario.inicializado = 1 and usuario.estado2=0 and usuario.baja=0";
...

                                    {
                                        ...
                                        $consulta="UPDATE usuario set estado2=0 where codTipoUsuario=2 and usuario.inicializado = 1 ";
                                ...
                                function ObtenerVendedorRandom(){
                                    ...
                                    $consulta="SELECT usuario.inicializado,usuario.estado2,persona.codPersona,concat(persona.nombre,' ',persona.apePat,' ',persona.apeMat) as nombre,codTipoUsuario,cargo,usuario.codUsuario as elusuario,persona.correo,persona.telefono from usuario inner join persona on usuario.codPersona=persona.codPersona where usuario.codTipoUsuario=2  and usuario.inicializado =1 and usuario.estado2=0 and usuario.baja=0";
                                ...
                                function ActualizarVendedorAsignado($codigodellLusuario){
                                    ...
                                    $consulta="UPDATE usuario set estado2=1 where codUsuario=$codigodellLusuario";
      ...
      $Mail->IsSMTP(); // Use SMTP
        ...
        $numeroPersonaRandom=$Vrandom->telefono;

         $correoPersonaRandom=$Vrandom->correo;

     
        $elnombrecompleto= $nombre.' '.$apellido;

        $lanota=$nota.'<br>'.$marca;
        $consulta="insert into prospecto (nombre, telefono, estado, codUsuario, codOrigenProspecto, fechaCreacion, email,notas,esEmpresa)

            values ('$elnombrecompleto', '$telefono', (select codEstadoProspecto from estado_prospecto where descripcion like '%Nuevo Prospecto%'), '$codVendedorRandom','$origen', SYSDATE(), '$correo','$lanota',0)";
...
// envio del correo
  ...
  $to  = $correoPersonaRandom.';gerenciageneral@autoplaza.com.bo;gerenciacomercial@autoplaza.com.bo;marketing@autoplaza.com.bo;';
  $copia = 'mferrufino@grt.com.bo;esandoval@sm.grt.com.bo;';
      //  $to  = "jesandovalcab@gmail.com";
       // $copia = "esandoval@sm.grt.com.bo";
        // subject
        $subject = 'Nuevo Prospecto Creado desde Landing Page: '.$elnombrecompleto.' #'.$codProspecto;
...
<body bgcolor="#FFF" style="margin:0 auto">
<table border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#FFF">
    <tbody>
    <tr>
    <td><center>
        <table border="0" cellspacing="0" cellpadding="0" width="600" bgcolor="#fdfdfd" style="border-bottom: 6px solid #033775;">
        <tbody>
        <tr>
        <td>
            ...
            <tbody>
                <tr>
                    <td width="244" align="left">
                        ...
                        <tbody>
                            <tr>
                                <td width="" align="left" style="color:#202020 ; font-family:calibri,arial,sans-serif; font-size:20px; padding:12px 0 0 12px">
                      ...
                      <td width="244" align="right">
                        ...
                        <tbody>
                            <tr>
                                <td width="" align="right" style="color:#202020 ; font-family:calibri,arial,sans-serif; font-size:20px; padding:12px 0 0 12px">
                          <img src="http://lbc.grt.com.bo/wp-content/uploads/2019/10/logo-autoplaza.png" width="250px"></td>
                            </tr>
                        </tbody>
                        </table>
                    </td>
                ...
                <tr>
                    <td width="588" align="left">
                        ...
                        <tbody>
                            <tr>
                                <td width="" align="left" style="color:#202020 ; font-family:calibri,arial,sans-serif; font-size:20px; padding:12px 0 0 12px">
                               <b>¡Prospecto creado desde LANDING PAGE!</b> 
                           </td>
                            </tr>
                        </tbody>
                        </table>
...
">
        ...
        <table cellspacing="0" cellpadding="0" width="600px" bgcolor="#fdfdfd" style="
    border-color: blue;
">
        <tbody style="
    border-color: blue;
">
    ...
    border-color: #FFF;
">
            <td valign="top" style="border-bottom:1px solid #dfdfdf;border-top:1px solid #033755;">
                <center>
                ...
                <td valign="top">
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td style="color:#414141;font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Estimado(a) '.$nombreVendedorRandom.',</td>
                            </tr>
                            <tr>
                                <td style="color:#414141;font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Se le acaba de asignar un nuevo prospecto creado desde la Landing Page con los siguientes datos:</td>
                            </tr>
                            <tr>
                                <td style="color:#414141;font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;"><table><tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Nombre:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$elnombrecompleto.'</td></tr>
                                    <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Teléfono:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$telefono.'</td></tr>
                                    <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Correo:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$correo.'</td></tr>
                                    <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Nota:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$nota.'</td></tr>
                                     <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Marca de interés:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$marca.'</td></tr>
                                </table></td>
                            </tr>
                            <tr>
                                <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Por favor, ingrese al CRM para gestionar el seguimiento. <a href="https://grt.com.bo/host/autoplaza/">Ir al CRM</a></td>
                            </tr>
    ...
    ">
        ...
        ';
           ...
           EnviarCorreoSMTP($to,$copia,$subject,$message);
...
//
   ...
   function NuevoProspectoAutoPlazaPorModelo($nombre,$apellido,$telefono,$ciudad,$nota,$origen,$correo,$pago,$codMarca,$codModelo,$marca,$modelo,$codTipo,$codSubtipo,$ingreso,$tipotrabajo){
      ...
      if ($nombre!="") {
            ...
            //************************************************************************ Traer Vendedor Random  *****************************************************
                                           ...
                                           function VerificarVendedoresRandom($lamarca){
...
SET     usuario.estado2=0
WHERE   usuario.codTipoUsuario=2 and usuario.inicializado=1  ";
                                ...
                                function ObtenerVendedorRandom($lamarca){
        ...
        $Mail = new PHPMailer();
      $Mail->IsSMTP(); // Use SMTP
        $Mail->Host        = "mail.gsca.com.bo"; // Sets SMTP server
        $Mail->SMTPDebug   = 0; // 2 to enable SMTP debug information
        $Mail->SMTPAuth    = TRUE; // enable SMTP authentication
        $Mail->SMTPSecure  = "tls"; //Secure conection
        $Mail->Port        = 26; // set the SMTP port
        $Mail->Username    = 'grt@gsca.com.bo'; // SMTP account username
        $Mail->Password    = 'fcIZ(tU;u_Fi'; // SMTP account password
        $Mail->Priority    = 1; // Highest priority - Email priority (1 = High, 3 = Normal, 5 = low)
        $Mail->CharSet     = 'UTF-8';
        $Mail->Encoding    = '8bit';
        $Mail->Subject     = $subject;
        ...
        VerificarVendedoresRandom($codMarca);

        $Vrandom= ObtenerVendedorRandom($codMarca);
        ...
        $lanota=$nota;
        if ($pago!="") {
        	$lanota.='<br>Forma de pago: '.$pago;
        }
        if ($ingreso!="") {
        	$lanota.='<br>Ingresos: '.$ingreso;
        }

        if ($tipotrabajo!="") {
        	$lanota.='<br>Tipo de trabajo: '.$tipotrabajo;
        }

        $consulta="insert into prospecto (nombre, telefono, estado, codUsuario, codOrigenProspecto, fechaCreacion, email,notas,esEmpresa,marcaLanding,modeloLanding,departamentoLanding,formaPagoLanding)

            values ('$elnombrecompleto', '$telefono', (select codEstadoProspecto from estado_prospecto where descripcion like '%Nuevo Prospecto%'), '$codVendedorRandom','$origen', SYSDATE(), '$correo','$lanota',0,'$codMarca','$codModelo','$ciudad','$pago')";
...
if ($ciudad==2) {
    $laciudadmail="SANTA CRUZ";
}
if ($ciudad==3) {
    $laciudadmail="COCHABAMBA";
}
if ($ciudad==4) {
    $laciudadmail="ORURO";
}
...
if ($ciudad==9) {
    $laciudadmail="PANDO";
        ...
        if ($success) {
            ...
            $this->NuevoSeguimiento($codProspecto,"SYSDATE()","1");
             $this->NuevoVehiculoProspecto($codProspecto,$codModelo,$codTipo,$codSubtipo);
...
// envio del correo
  ...
  $to  = $correoPersonaRandom.';mfbaldomar@gsca.com.bo';
  $copia = 'mferrufino@grt.com.bo;esandoval@sm.grt.com.bo;';
      //  $to  = "jesandovalcab@gmail.com;";
       // $copia = "esandoval@sm.grt.com.bo";
        // subject
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#FFF">
    ...
    <tr>
    <td><center>
        <table border="0" cellspacing="0" cellpadding="0" width="600" bgcolor="#fdfdfd" style="border-bottom: 6px solid #23282d;">
        <tbody>
        <tr>
        <td>
         <table border="0" cellspacing="0" cellpadding="0" style="
                    ...
                    <td width="244" align="left">
                      ...
                      <td width="244" align="right">
                        ...
                        <tbody>
                            <tr>
                                <td width="" align="right" style="color:#202020 ; font-family:calibri,arial,sans-serif; font-size:20px; padding:12px 0 0 12px">
                          <img src="http://chery.com.bo/cotizador/wp-content/uploads/2020/03/favicon-chery.png" width="100px"></td>
                            </tr>
                        </tbody>
                        </table>
                    </td>
                ...
                <td valign="top">
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                <td style="color:#414141;font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;"><table><tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Nombre:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$elnombrecompleto.'</td></tr>
                                    ...
                                    <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Correo:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$correo.'</td></tr>
                                     ...
                                     <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Marca:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$marca.'</td></tr>

                                      <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Modelo:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$modelo.'</td></tr>

                                       <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Departamento de residencia:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$laciudadmail.'</td></tr>

                                       <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Forma de pago:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$pago.'</td></tr>

                                       <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Ingresos:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$ingreso.'</td></tr>

                                       <tr> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Tipo de trabajo:</td> <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">'.$tipotrabajo.'</td></tr>
                            ...
                            <tr>
                                <td style="font-family:calibri,arial,sans-serif;font-size:14px;font-weight:bold;padding:17px 0 13px 17px;text-align: justify;">Por favor, ingrese al CRM para gestionar el seguimiento. <a href="https://grt.com.bo/host/chery/">Ir al CRM</a></td>
                            </tr>
...
//
   ...
   function NuevoProspectoAutoPlazaPorModeloOLD($nombre,$apellido,$telefono,$ciudad,$nota,$origen,$correo,$pago,$codMarca,$codModelo,$marca,$modelo){
      ...
      if ($nombre!="") {
            ...
            //************************************************************************ Traer Vendedor Random  *****************************************************
                                    ...
                                    $consulta="SELECT usuario.inicializado,usuario.estado2,persona.codPersona,concat(persona.nombre,' ',persona.apePat,' ',persona.apeMat) as nombre,codTipoUsuario,cargo,usuario.codUsuario as elusuario from usuario inner join persona on usuario.codPersona=persona.codPersona left join usuarioMarca on usuarioMarca.codUsuario= usuario.codUsuario where usuario.codTipoUsuario=2  and usuario.inicializado = 1 and usuario.estado2=0 and usuario.baja=0 and usuarioMarca.codMarca='$lamarca' ";
...
LEFT JOIN
        usuarioMarca
ON      usuarioMarca.codUsuario = usuario.codUsuario
SET     usuario.estado2=0
WHERE   usuario.codTipoUsuario=2 and usuario.inicializado=1 and usuarioMarca.codMarca='".$lamarca."' ";
                                ...
                                function ObtenerVendedorRandom($lamarca){
                                    ...
                                    $consulta="SELECT usuario.inicializado,usuario.estado2,persona.codPersona,concat(persona.nombre,' ',persona.apePat,' ',persona.apeMat) as nombre,codTipoUsuario,cargo,usuario.codUsuario as elusuario,persona.correo,persona.telefono from usuario inner join persona on usuario.codPersona=persona.codPersona left join usuarioMarca on usuarioMarca.codUsuario=usuario.codUsuario where usuario.codTipoUsuario=2  and usuario.inicializado =1 and usuario.estado2=0 and usuario.baja=0 and usuarioMarca.codMarca='".$lamarca."' ";
...
//
    ...
    function NuevoProspecto2($nombre,$apellido,$correo,$telefono,$origen,$ciudad,$tipovivienda,$tipocasa){
            ...
            //************************************************************************ Traer Vendedor Random  *****************************************************
                                    ...
                                    $consulta="SELECT usuario.inicializado,usuario.estado,persona.codPersona,concat(persona.nombre,' ',persona.apePat,' ',persona.apeMat) as nombre,codTipoUsuario,cargo,usuario.codUsuario as elusuario from usuario inner join persona on usuario.codPersona=persona.codPersona where usuario.codTipoUsuario=2 and usuario.codOficina=5 and usuario.inicializado is null and usuario.estado=0 and usuario.baja=0";
...

                                    {
                                        ...
                                        $consulta="UPDATE usuario set estado=0 where codTipoUsuario=2 and usuario.codOficina=5";
                                ...
                                function ObtenerVendedorRandom(){
                                    ...
                                    $consulta="SELECT usuario.inicializado,usuario.estado,persona.codPersona,concat(persona.nombre,' ',persona.apePat,' ',persona.apeMat) as nombre,codTipoUsuario,cargo,usuario.codUsuario as elusuario,persona.correo from usuario inner join persona on usuario.codPersona=persona.codPersona where usuario.codTipoUsuario=2 and usuario.codOficina=5 and usuario.inicializado is null and usuario.estado=0 and usuario.baja=0";
      ...
      $Mail->IsSMTP(); // Use SMTP
        ...
        $consulta="insert into prospecto (primerNombre, primerApellido, estado, codUsuario, codPersona, codOrigenProspecto, fechaCreacion, email,  telefono,ciudad,tipovivienda,tipocasa,notas)

            values ('$nombre', '$apellido', (select codEstadoProspecto from estado_prospecto where descripcion like '%Nuevo Prospecto%'), '$codVendedorRandom','$codVendedorRandom','$origen', SYSDATE(), '$correo', '$telefono','$ciudad','$tipovivienda','$tipocasa','Lugar de residencia: ".$ciudad."<br>Vive o Alquila: ".$tipovivienda."<br>Tipo de Vivienda: ".$tipocasa."')";
        ...
        if ($success) {
           ...
           EnviarCorreoSMTP("jesandovalcab@gmail.com","",'prueba correo smtssssssp',"correo de prueba enviado desde http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");
    ...
    function NuevoSeguimiento($cod, $fecha, $tipo){
        ...
        $consulta="insert into seguimiento(codProspecto, fechaAlta, fechaProxContacto, codTipoContacto) values ($cod, SYSDATE(), $condfecha, $tipo)
    ...
    function NuevoVehiculoProspecto($codProspecto,$codModelo,$codTipo,$codSubTipo){
        ...
        $consulta="insert into vehiculo_prospecto(codProspecto, codModelo, codTipo, codSubTipo,baja) values ('$codProspecto','$codModelo','$codTipo','$codSubTipo','0')
