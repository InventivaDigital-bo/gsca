...
require_once "../clases/mysql.class2.php";
...
CONCAT(uas.nombre,' ',uas.apePat) as asignado, cli.baja,
...
where det.codPedido='$codcotizacion' and det.baja='0' group by p.codSAP order by p.codSAP ";
        //echo $consulta;
        $db->Query($consulta);
        return $db;
    }
