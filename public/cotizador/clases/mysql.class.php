...
{
	// DATOS LOCALES ***********************************************************************
	private $db_host    = "104.131.56.51"; // server name
	private $db_user    = "chery";          // user name
	private $db_pass    = "vFQE0cFBG5lFOe9x";          // password
        private $db_dbname  = "bdChery";          // database name
	...
	*/
	...
	public function Open($database = null, $server = null, $username = null,
		...
		$this->mysql_link->set_charset("utf8");
